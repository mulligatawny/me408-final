...
fig1 = plt.figure(1)
plt.contourf(x, y, u, cmap=cm.inferno, vmin=-.4, vmax=.4)
plt.colorbar()
plt.xlabel('$x$')
plt.ylabel('$y$')
...
fig2 = plt.figure(2)
plt.contourf(x, y, v, cmap=cm.inferno, vmin=-.4, vmax=.4)
plt.colorbar()
plt.xlabel('$x$')
plt.ylabel('$y$')
...
fig3 = plt.figure(3)
plt.contourf(x, y, w, cmap=cm.GnBu, vmin=-.4, vmax=.4)
plt.colorbar()
plt.xlabel('$x$')
plt.ylabel('$y$')
...
fig4 = plt.figure(4)
plt.contourf(x, y, p, cmap=cm.OrRd, vmin=.97, vmax=1.03)
plt.colorbar()
plt.xlabel('$x$')
plt.ylabel('$y$')
