...
fig1 = plt.figure(1)
plt.contourf(x, y, u, cmap=cm.inferno, vmin=-.18, vmax=.18)
plt.colorbar()
plt.xlabel('$x$')
plt.ylabel('$y$')
...
fig2 = plt.figure(2)
plt.contourf(x, y, v, cmap=cm.inferno, vmin=-.18, vmax=.18)
plt.colorbar()
plt.xlabel('$x$')
plt.ylabel('$y$')
...
fig3 = plt.figure(3)
plt.contourf(x, y, w, cmap=cm.GnBu, vmin=-.18, vmax=.18)
plt.colorbar()
plt.xlabel('$x$')
plt.ylabel('$y$')
...
fig4 = plt.figure(4)
plt.contourf(x, y, p, cmap=cm.OrRd, vmin=.995, vmax=1.005)
plt.colorbar()
plt.xlabel('$x$')
plt.ylabel('$y$')
